...
Use `preliminary` quando faltar qualquer campo essencial do MVP. Use `ready`
somente após conferir problema, público, promessa, jornada, conta, onboarding,
ativação, cobrança, suporte, escopo, preço, custo, tecnologia, aquisição e
métricas.
