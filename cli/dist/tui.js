...
export class MvpfyTui {
    ...
    async refresh() {
        try {
            ...
            this.setStatus(`${snapshot.project}  ·  ${snapshot.overall}% do MVP  ·  atualização automática ativa`);
        }
        catch (error) {
    ...
    renderProgress(body) {
        ...
        blessed.box({
            ...
            valign: "middle",
            content: "Visão consolidada do andamento do MVP. Os números são recalculados " +
    ...
    renderSkills(body) {
        blessed.box({
            ...
            label: " Gerenciamento ",
            padding: { left: 1, right: 1 },
            content: "I  instalar ou reconciliar as skills do MVPFy\n" +
    ...
    renderAbout(body) {
        blessed.box({
            ...
            align: "center",
            valign: "middle",
            content: `{bold}MVPFy v${VERSION}{/bold}\n\n` +
